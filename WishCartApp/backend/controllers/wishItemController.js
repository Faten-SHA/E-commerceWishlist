...
module.exports.updateWishItem = async (req, res) => {
    ...
    wishItemModel.findByIdAndUpdate(_id,{text})
    .then((data) => {
...
module.exports.deleteWishItem = async (req, res) => {
    const {_id} = req.body;
    wishItemModel.findByIdAndDelete(_id).then((data) => {
